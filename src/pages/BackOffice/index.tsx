...
export default function BackOffice() {
  ...
  const SECTIONS: Record<BOSection, React.ReactNode> = {
    ...
    'work-gallery': <WorkGalleryEditor onSaved={refreshIframe} />,
  };
